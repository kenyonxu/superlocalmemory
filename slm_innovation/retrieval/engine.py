"""SLM Innovation — Retrieval Engine (4-Channel Orchestrator).
...
from slm_innovation.core.config import ChannelWeights, RetrievalConfig
from slm_innovation.retrieval.fusion import FusionResult, weighted_rrf
from slm_innovation.retrieval.strategy import QueryStrategy, QueryStrategyClassifier
