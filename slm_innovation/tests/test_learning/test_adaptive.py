"""Tests for slm_innovation.learning.adaptive — Adaptive Learning (3-Phase).
...
from slm_innovation.storage import schema as real_schema
from slm_innovation.storage.database import DatabaseManager
from slm_innovation.storage.models import AtomicFact, FeedbackRecord, MemoryRecord
from slm_innovation.learning.adaptive import AdaptiveLearner, _MIN_FEEDBACK_FOR_TRAINING
