"""Tests for slm_innovation.retrieval.temporal_channel — 3-Date Temporal Search.
...
from slm_innovation.retrieval.temporal_channel import (
    TemporalChannel,
    _parse_iso,
    _proximity_score,
)
...
class TestTemporalChannelSearch:
    ...
    def test_referenced_date_match(self) -> None:
        ...
        with patch(
            "slm_innovation.retrieval.temporal_channel.TemporalParser"
        ) as MockParser:
