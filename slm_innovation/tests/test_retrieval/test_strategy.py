"""Tests for slm_innovation.retrieval.strategy — Query-Adaptive Strategy.
...
from slm_innovation.retrieval.strategy import (
    STRATEGY_PRESETS,
    QueryStrategy,
...
class TestStrategyPresets:
    ...
    def test_preset_names(self) -> None:
        expected = {"temporal", "multi_hop", "aggregation", "opinion", "factual", "entity", "general"}
