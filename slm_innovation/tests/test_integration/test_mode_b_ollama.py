...
Run:
    pytest slm_innovation/tests/test_integration/test_mode_b_ollama.py -v -m ollama
...
from slm_innovation.core.config import (
    EmbeddingConfig,
    LLMConfig,
    RetrievalConfig,
    SLMConfig,
...
from slm_innovation.storage.models import Mode, RecallResponse
