"""Tests for slm_innovation.encoding.type_router.
...
from slm_innovation.encoding.type_router import TypeRouter, _cosine
from slm_innovation.storage.models import AtomicFact, FactType, Mode
