"""Tests for slm_innovation.encoding.signal_inference.
...
from slm_innovation.encoding.signal_inference import (
    infer_signal,
    infer_signal_scores,
)
from slm_innovation.storage.models import SignalType
