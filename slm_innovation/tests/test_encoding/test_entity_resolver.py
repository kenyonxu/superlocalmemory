"""Tests for slm_innovation.encoding.entity_resolver.
...
from slm_innovation.encoding.entity_resolver import (
...
from slm_innovation.storage.models import CanonicalEntity, EntityAlias
