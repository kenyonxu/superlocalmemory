"""Tests for slm_innovation.encoding.fact_extractor.
...
from slm_innovation.core.config import EncodingConfig
from slm_innovation.encoding.fact_extractor import (
    FactExtractor,
    _classify_sentence,
...
from slm_innovation.storage.models import AtomicFact, FactType, Mode, SignalType
