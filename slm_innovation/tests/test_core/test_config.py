"""Tests for slm_innovation.core.config — SLMConfig + sub-configs.
...
class TestChannelWeights:
    ...
    def test_as_dict(self) -> None:
        ...
        assert d["bm25"] == 1.5
        assert set(d.keys()) == {"semantic", "bm25", "entity_graph", "temporal"}
...
class TestSubConfigs:
    ...
    def test_math_defaults(self) -> None:
        ...
        assert mc.rate_distortion_enabled is False
