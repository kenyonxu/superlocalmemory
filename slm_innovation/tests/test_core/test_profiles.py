"""Tests for slm_innovation.core.profiles — ProfileManager CRUD.
...
from slm_innovation.core.profiles import ProfileManager
from slm_innovation.storage.models import Mode, Profile
