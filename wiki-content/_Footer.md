...
**SuperLocalMemory V4.0.5** — Local-first memory with explicit data-path controls. Current docs: [Home](Home) · [Installation](Installation) · [CLI](CLI-Reference) · [MCP whole 94 (full 49)](MCP-Tools) · [FAQ](FAQ)
